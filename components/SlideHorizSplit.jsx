...
const SlideHorizSplit = ({ title, topContent, bottomContent }) => (
  <Card
    sx={{
      width: '1080px',
      height: '1080px',
  ...
  >
    ...
    <Box sx={{ flex: 1, padding: '10px', boxSizing: 'border-box' }}>
      <Typography variant="body1">{topContent}</Typography>
    </Box>
    <Box sx={{ flex: 1, padding: '10px', boxSizing: 'border-box' }}>
